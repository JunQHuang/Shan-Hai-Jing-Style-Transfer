(function ($) {
  ...
  $.fn.wPaint.menus.main = {
    img: 'static/plugins/main/img/icons-menu-main.png',
    items: {
      undo: {
        icon: 'generic',
        title: 'Undo',
  ...
  $.extend($.fn.wPaint.cursors, {
    'default': {path: 'static/plugins/main/img/cursor-crosshair.png', left: 7, top: 7},
    dropper:   {path: 'static/plugins/main/img/cursor-dropper.png', left: 0, top: 12},
    pencil:    {path: 'static/plugins/main/img/cursor-pencil.png', left: 0, top: 11.99},
    bucket:    {path: 'static/plugins/main/img/cursor-bucket.png', left: 0, top: 10},
    eraser1:   {path: 'static/plugins/main/img/cursor-eraser1.png', left: 1, top: 1},
    eraser2:   {path: 'static/plugins/main/img/cursor-eraser2.png', left: 2, top: 2},
    eraser3:   {path: 'static/plugins/main/img/cursor-eraser3.png', left: 2, top: 2},
    eraser4:   {path: 'static/plugins/main/img/cursor-eraser4.png', left: 3, top: 3},
    eraser5:   {path: 'static/plugins/main/img/cursor-eraser5.png', left: 3, top: 3},
    eraser6:   {path: 'static/plugins/main/img/cursor-eraser6.png', left: 4, top: 4},
    eraser7:   {path: 'static/plugins/main/img/cursor-eraser7.png', left: 4, top: 4},
    eraser8:   {path: 'static/plugins/main/img/cursor-eraser8.png', left: 5, top: 5 },
    eraser9:   {path: 'static/plugins/main/img/cursor-eraser9.png', left: 5, top: 5},
    eraser10:  {path: 'static/plugins/main/img/cursor-eraser10.png', left: 6, top: 6}
  });
